...
const { checkBinaryExist, infoMessage, projectDirectory, errorMessage, currentEditor, copyPintJson } = require("./methods")
const { PINT_BINARY } = require("./constants")

/**
 * Runs the Laravel Pint command on the current file.       
 * @returns None       
 */
exports.formatCurrentFile = async () => {
    if (!checkBinaryExist()) {
